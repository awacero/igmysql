...
<<<<<<< HEAD
CREATE TABLE events ( eventID VARCHAR(80), latitude DOUBLE(8,44), longitude DOUBLE(8,4), description VARCHAR(200), magVal DOUBLE(6,3), magType VARCHAR(20),timestampSec DATETIME, timestampNow DATETIME, depth DOUBLE(12,4), status VARCHAR(20), revision INT(10), localizacion VARCHAR(200), horaLocal DATETIME, PRIMARY KEY (eventID) ); 
=======
...
>>>>>>> 743aa781e925eb25b2ebc4845ba9bd2a2bf796b9
